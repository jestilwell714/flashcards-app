...
export default function Explorer() {
    ...
    return (   
            <div className="grad overflow-y-auto grid grid-rows-[33vh_1fr] h-dvh justify-around w-screen relative">
                <div>
                ...
                {mode !== "cram" && <FileExplorer refreshKey={refreshKey} tagMode={tagMode} setTagMode={setTagMode} onCreate={triggerRefresh}/>}
            </div>
    );    
}